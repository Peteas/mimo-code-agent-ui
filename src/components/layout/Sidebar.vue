  ...
  >
    <div class="p-4 border-b border-[var(--color-border)]">
      <div class="flex items-center gap-2">
        <div class="w-8 h-8 rounded-lg bg-[var(--color-primary)] text-white flex items-center justify-center font-bold text-sm" aria-hidden="true">M</div>
        <div>
    ...
    <div class="flex-1 overflow-y-auto px-2 space-y-1">
      <div
        ...
        role="button"
        :aria-current="session === currentSessionId ? 'true' : undefined"
      >
